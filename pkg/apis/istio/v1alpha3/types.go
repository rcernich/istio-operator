...
type GlobalConfig struct {
	...
	// Cannot de/serialize meshv1alpha1.Network because of protobuf oneof JSON serialization issues.
	// MeshNetworks map[string]meshv1alpha1.Network `json:"meshNetworks,omitempty"`
	MeshNetworks interface{} `json:"meshNetworks,omitempty"`
