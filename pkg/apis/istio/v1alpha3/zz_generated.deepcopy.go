	...
	*out = *in
	...
	if in.ComponentStatus != nil {
		...
		*out = make(map[string]ComponentStatus, len(*in))
		for key, val := range *in {
			newVal := new(ComponentStatus)
			val.DeepCopyInto(newVal)
			(*out)[key] = *newVal
		}
	}
	out.ReleaseInfo = in.ReleaseInfo.DeepCopy()
	return
}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReleaseInfoType.
func (in ReleaseInfoType) DeepCopy() ReleaseInfoType {
	if in == nil {
		return nil
	}
	out := new(ReleaseInfoType)
	in.DeepCopyInto(out)
	return *out
}
